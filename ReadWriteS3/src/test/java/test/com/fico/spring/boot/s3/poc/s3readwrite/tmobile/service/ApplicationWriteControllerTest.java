...
public class ApplicationWriteControllerTest
{
    @Autowired
    ...
    Logger logger =  LoggerFactory.getLogger(ApplicationWriteControllerTest.class);  
    ...
    public void writeS3StorageTest()
    {
        ...
        ResponseEntity<String> response = restTemplate.exchange("/tmobile/write/usa", HttpMethod.POST, entity, String.class);
...
}//End of class ApplicationWriteServiceTest
